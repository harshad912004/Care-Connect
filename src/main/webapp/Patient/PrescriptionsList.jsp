...
<body>
    ...
    <div class="search_div" style="margin-left:5%;">
    	...
    	<table border='1' id="dataTable" class="data_tables">
	        ...
	        %>
		            	<tr>
							...
							<td>
					    		<a href="PatientServlet?action=view_prescription&id=<%= data.getId() %>" class="view_prescription_button">View</a>
					    	</td>
		    			</tr>
	        <% 
	                }
            ...
            %>            
    	</table><div id="patientappointmentData">    
