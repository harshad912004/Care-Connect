...
<body>
    ...
    <p class="container_heading">NEWLY REQUESTED APPOINTMENTS</p>    
        ...
        %>
	            	<tr>
			    		...
			    		<td style="text-align: center;">
			    			<a href="PatientServlet?action=cancel_appointment&id=<%= data.getId() %>" class="cancel_appointment_button">Cancel Appointment</a>
			    		</td>
	    			</tr>
        <% 
                }
